...
<head>
        ...
        <meta content="A fully featured CRM, CMS, etc." name="description" />
                        ...
                        <li class="dropdown">
                            <a class="nav-link dropdown-toggle arrow-none nav-user px-2" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                                ...
                                <span class="d-lg-flex flex-column gap-1 d-none">
                                    ...
                                    <h6 class="my-0 fw-normal"><?= session()->get('email'); ?></h6>
                                </span>
                            </a>
            ...
            <div class="leftside-menu">
                ...
                <div class="h-100" id="leftside-menu-container" data-simplebar>
                    ...
                    <ul class="side-nav">
                        ...
                        <li class="side-nav-item">
                            <a href="createUser" class="side-nav-link">
                                <i class="uil-home-alt"></i>
                                <span> Add Users </span>
                            </a>
                        </li>
                        ...
                        <li class="side-nav-item">
                            <a href="serviceList" class="side-nav-link">
                                <i class="uil-rss"></i>
                                <span>List of Services</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a href="createService" class="side-nav-link">
                                <i class="uil-rss"></i>
